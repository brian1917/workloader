...
func RootTemplate() string {
  ...
  Reporting Commands:{{range .Commands}}{{if (or (eq .Name "rule-usage") (eq .Name "port-usage") (eq .Name "mislabel") (eq .Name "dupecheck") (eq .Name "appgroup-flow-summary") (eq .Name "legacy-explorer") (eq .Name "traffic") (eq .Name "nic-export") (eq .Name "service-finder") (eq .Name "process-export") (eq .Name "wkld-ipl-mapping") (eq .Name "ven-health") (eq .Name "unused-umwl"))}}
	{{rpad .Name .NamePadding }} {{.Short}}{{end}}{{end}}{{end}}{{if .HasAvailableLocalFlags}}
