...
func RootTemplate() string {
  ...
  Import/Export Commands:{{range .Commands}}{{if (or (eq .Name "wkld-import") (eq .Name "wkld-export") (eq .Name "ipl-export") (eq .Name "ipl-import") (eq .Name "label-export") (eq .Name "svc-export") (eq .Name "ruleset-export") (eq .Name "labelgroup-export") (eq .Name "flow-import") (eq .Name "template-import"))}}
	{{rpad .Name .NamePadding }} {{.Short}}{{end}}{{end}}{{end}}{{if .HasAvailableLocalFlags}}
