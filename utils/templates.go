...
func RootTemplate() string {
  ...
  Automation Commands:{{range .Commands}}{{if (or (eq .Name "traffic") (eq .Name "azure-label") (eq .Name "aws-label") (eq .Name "gcp-label") (eq .Name "subnet") (eq .Name "hostparse") (eq .Name "dag-sync"))}}
	{{rpad .Name .NamePadding }} {{.Short}}{{end}}{{end}}{{end}}{{if .HasAvailableLocalFlags}}
