...
func RootTemplate() string {
  ...
  PCE Management Commands:{{range .Commands}}{{if (or (eq .Name "all-pces") (eq .Name "target-pces") (eq .Name "pce-remove") (eq .Name "pce-add") (eq .Name "get-default") (eq .Name "set-default") (eq .Name "pce-list"))}}
