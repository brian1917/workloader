...
Download the binary for your operating system from the `bin` folder of this repository. Direct links for each operating systems are here: (https://github.com/brian1917/workloader/raw/master/bin/workloader-mac)[Mac], (https://github.com/brian1917/workloader/raw/master/bin/workloader-linux)[Linux], and (https://github.com/brian1917/workloader/raw/master/bin/workloader-windows)[Windows]. No other installation required.
