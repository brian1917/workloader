...
var ExplorerCmd = &cobra.Command{
	...
	Long: `
NOTE - This command is no longer under active maintenance. It is being replaced by the traffic command. It will remain in workloader for a while until traffic has better backwards compatibility with all options in this command.
